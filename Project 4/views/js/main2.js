...
//Nirmala: reducing the var keyword loop up
...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    ...
    for (var i = 0, randomPizzaContainer = document.querySelectorAll(".randomPizzaContainer"); i < randomPizzaContainer.length; i++) {
...
//Nirmala: Pulling out redundant variable assignment
...
function updatePositions() {
  ...
  //Nirmala: Pulling out the variable to avoid multiple times of variable redundant assignement
