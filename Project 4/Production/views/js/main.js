...
/* NIRMALA'S MODIFICATIONS:
THERE'S NO REAL NEED TO KEEP THE PIZZAS HAVE UNIQUE ID
*/
...
function changeSliderLabel(size) {
  ...
  /* NIRMALA'S MODIFICATIONS:
  MOVING THIS FUNCTION OUTSIDE THE SECOND FUNCTION
  */
  ...
  function changePizzaSizes(size) {
    /* NIRMALA'S MODIFICATIONS:
    THE PIZZA CONTAINERS ARE SAME SIZE
    */
...
/* NIRMALA'S MODIFICATIONS:
Moving the label definition outside to global scope
*/
...
/* NIRMALA'S MODIFICATIONS:
THIS VAR CAN BE OUTSIDE THE LOOP
*/
...
function updatePositions() {
  ...
  /* NIRMALA'S MODIFICATIONS
  MOVED THE REPETITIVE CALCULATION THAT'S INDEPENDENT OF THE LOOP OUTSIDE THE LOOP
  SET THE LENGTH OF THE ARRAY TO BE A VARIABLE
  */
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var s = 256;
  /* NIRMALA'S MODIFICATIONS:
  MOVING THIS OUT TO AVOID MULTIPLE QUERIES */
  var movingSlider = document.querySelector("#movingPizzas1");
  /*NIRMALA'S MODIFICATIONS
  WE CURRENTLY SHOW A MAXIMUM OF 5 ELEMENTS PER COL AND COL IS SET TO BE 8
  */
  for (var i = 0; i < 40; i++) {
